Hands Cat's Cradle (双手翻绳) Simulation V2.0 (Enhanced Edition)This is an optimized, feature-rich version of the Cat's Cradle hand-tracking simulator. It leverages MediaPipe Hands, CSS glassmorphism, dynamic Web Audio synthesizers, and Verlet integration physics to deliver a premium interactive art experience.New Features in V2.0

Shape Challenge Mode (形状挑战):
...
Dynamic Chord Pad Synthesizer (背景和弦声垫):
...
Visual Themes & Particles (全息主题与动态粒子):
...
How to RunModern browsers block webcam and Web Audio APIs unless served over localhost or HTTPS.
